                ...
                <div className="flex h-16 items-center justify-between">
                    <div className="flex items-center">
                        <div className="shrink-0">
                            <img className="size-8" src="https://tailwindui.com/plus/img/logos/mark.svg?color=indigo&shade=500" alt="SnapCheckIT" />
                        </div>
                        ...
                        <div className="ml-4 flex items-center md:ml-6">
                            ...
                            <div className="relative ml-3">
                                ...
                                <div className="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black/5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabIndex={-1}>
                                    <a href="https://www.snapcheckit.com" className="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabIndex={-1} id="user-menu-item-0">Support</a>
            ...
            <div className="md:hidden" id="mobile-menu">
                ...
                <div className="border-t border-gray-700 pb-3 pt-4">
                    <div className="flex items-center px-5">
                        ...
                        <div className="ml-3">
                            <div className="text-base/5 font-medium text-white">Anders Lind</div>
                            <div className="text-sm font-medium text-gray-400">snapcheckitinc@outlook.com</div>
                        </div>
